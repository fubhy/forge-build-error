...
contract YearnVaultV2PriceFeed is
  ...
  SingleUnderlyingDerivativeRegistryMixin
{
    ...
    override
  {
    ...
    require(
      isValidYearnVaultV2,
      "__validateDerivative: Invalid yVault for underlying"
    );
  ...
  function getYearnVaultV2Registry()
    public
    view
    returns (address yearnVaultV2Registry_)
  {
