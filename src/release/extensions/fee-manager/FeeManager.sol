  ...
  PermissionedVaultActionMixin
{
  ...
  function setConfigForFund(
    ...
    require(
      fees.isUniqueSet(),
      "setConfigForFund: fees cannot include duplicates"
    );
  ...
  function __payoutSharesOutstandingForFees(
    address _comptrollerProxy,
  ...
  function __payoutSharesOutstanding(
    ...
    uint256 sharesOutstanding = getFeeSharesOutstandingForFund(
      _comptrollerProxy,
      _fee
    );
    ...
    address payee = __parseFeeRecipientForFund(
      _comptrollerProxy,
      _vaultProxy,
      _fee
    );
    ...
    emit SharesOutstandingPaidForFund(
      _comptrollerProxy,
      _fee,
      payee,
      sharesOutstanding
  ...
  function __settleFee(
    ...
    (SettlementType settlementType, address payer, uint256 sharesDue) = IFee(
      _fee
    ).settle(_comptrollerProxy, _vaultProxy, _hook, _settlementData, _gav);
    ...
    if (settlementType == SettlementType.Direct) {
      ...
      comptrollerProxyToFeeToSharesOutstanding[_comptrollerProxy][
        _fee
      ] = comptrollerProxyToFeeToSharesOutstanding[_comptrollerProxy][_fee].add(
        sharesDue
      );
      ...
      comptrollerProxyToFeeToSharesOutstanding[_comptrollerProxy][
        _fee
      ] = comptrollerProxyToFeeToSharesOutstanding[_comptrollerProxy][_fee].sub(
        sharesDue
      );
  ...
  function getFeeSharesOutstandingForFund(
    address _comptrollerProxy,
    address _fee
  ) public view returns (uint256 sharesOutstanding_) {
