...
abstract contract SynthetixActionsMixin is AssetHelpers {
    ...
    {
        return
            ISynthetixSynth(ISynthetixProxyERC20(_synth).target())
                .currencyKey();
    }
    ...
    function getSynthetixOriginator()
        public
        view
        returns (address synthetixOriginator_)
    {
    ...
    function getSynthetixRedeemer()
        public
        view
        returns (address synthetixRedeemer_)
    {
    ...
    function getSynthetixTrackingCode()
        public
        view
        returns (bytes32 synthetixTrackingCode_)
    {
