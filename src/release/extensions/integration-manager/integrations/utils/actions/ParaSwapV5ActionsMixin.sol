...
abstract contract ParaSwapV5ActionsMixin is AssetHelpers {
    ...
    function __paraSwapV5MultiSwap(
        ...
        __approveAssetMaxAsNeeded(
            _fromToken,
            getParaSwapV5TokenTransferProxy(),
            _fromAmount
        );

        IParaSwapV5AugustusSwapper.SellData memory sellData = IParaSwapV5AugustusSwapper
            .SellData({
        ...
        IParaSwapV5AugustusSwapper(getParaSwapV5AugustusSwapper()).multiSwap(
            sellData
        );
    }
    ...
    function getParaSwapV5AugustusSwapper()
        public
        view
        returns (address augustusSwapper_)
    {
    ...
    function getParaSwapV5TokenTransferProxy()
        public
        view
        returns (address tokenTransferProxy_)
    {
