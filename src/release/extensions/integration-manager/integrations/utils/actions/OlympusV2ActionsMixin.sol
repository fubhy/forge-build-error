...
abstract contract OlympusV2ActionMixin {
    ...
    function __olympusV2Stake(address _vaultProxy, uint256 _outgoingAssetAmount)
        internal
    {
    ...
    function getOlympusV2StakingContract()
        public
        view
        returns (address stakingContract_)
    {
