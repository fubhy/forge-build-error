...
contract YearnVaultV2Adapter is AdapterBase, YearnVaultV2ActionsMixin {
    ...
    function __getUnderlyingForYVault(address _yVault)
        private
        view
        returns (address underlying_)
    {
        return
            YearnVaultV2PriceFeed(getYearnVaultV2PriceFeed())
                .getUnderlyingForDerivative(_yVault);
    }
        ...
        )
    {
        ...
        require(
            ...
            "__parseAssetsForLend: Unsupported yVault"
        );
        ...
        )
    {
        ...
        require(
            underlying != address(0),
            "__parseAssetsForRedeem: Unsupported yVault"
        );
    ...
    function getYearnVaultV2PriceFeed()
        public
        view
        returns (address yearnVaultV2PriceFeed_)
    {
