...
contract ConvexCurveLpStakingAdapter is
    CurveLiquidityAdapterBase,
    StakingWrapperActionsMixin
{
    ConvexCurveLpStakingWrapperFactory
        private immutable STAKING_WRAPPER_FACTORY_CONTRACT;
    ...
    function claimRewards(
        ...
        __stakingWrapperClaimRewardsFor(
    ...
    function unstake(
        ...
        (
            ...
            uint256 amount
        ) = __decodeUnstakeCallArgs(_actionData);
        ...
        )
    {
        ...
        spendAssets_[0] = STAKING_WRAPPER_FACTORY_CONTRACT
            .getCurveLpTokenForWrapper(incomingStakingToken);
        ...
        )
    {
        ...
        incomingAssets_ = new address[](1);
        incomingAssets_[0] = STAKING_WRAPPER_FACTORY_CONTRACT
            .getCurveLpTokenForWrapper(outgoingStakingToken);
        ...
        )
    {
        ...
        (
            incomingAssets_,
            minIncomingAssetAmounts_
        ) = __parseIncomingAssetsForRedemptionCalls(
            pool,
            useUnderlyings,
            redeemType,
            incomingAssetsData
    ...
    function __validatePoolForWrapper(address _pool, address _wrapper)
        private
        view
    {
        address lpToken = STAKING_WRAPPER_FACTORY_CONTRACT
            .getCurveLpTokenForWrapper(_wrapper);
        require(
