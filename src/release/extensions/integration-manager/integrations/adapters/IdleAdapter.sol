...
contract IdleAdapter is AdapterBase, IdleV4ActionsMixin {
        ...
        postActionSpendAssetsTransferHandler(_vaultProxy, _assetData)
    {
        ...
        __pushFullAssetBalances(
            _vaultProxy,
            __idleV4GetRewardsTokens(idleToken)
        );
    }
    ...
    {
        return
            IdlePriceFeed(IDLE_PRICE_FEED).getUnderlyingForDerivative(
                _idleToken
            );
    }
        ...
        )
    {
        ...
        require(
            ...
            "__parseAssetsForLend: Unsupported idleToken"
        );
        ...
        )
    {
        ...
        require(
            underlying != address(0),
            "__parseAssetsForRedeem: Unsupported idleToken"
        );
