...
contract CompoundDebtPositionLib is
  CompoundDebtPositionLibBase1,
  ICompoundDebtPosition
{
  ...
  function receiveCallFromVault(bytes memory _actionData) external override {
    ...
    (address[] memory assets, uint256[] memory amounts, bytes memory data) = abi
      .decode(actionArgs, (address[], uint256[], bytes));
  ...
  function __addCollateralAssets(
    ...
    uint256[] memory enterMarketErrorCodes = ICompoundComptroller(
  ...
  function assetIsCollateral(address _asset)
    public
    view
  ...
  function getCompoundComptroller()
    public
    view
    returns (address compoundComptroller_)
  {
