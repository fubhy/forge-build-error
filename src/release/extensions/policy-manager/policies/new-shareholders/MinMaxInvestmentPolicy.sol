...
contract MinMaxInvestmentPolicy is PolicyBase {
    ...
    {
        uint256 minInvestmentAmount = comptrollerProxyToFundSettings[
            _comptrollerProxy
        ].minInvestmentAmount;
        uint256 maxInvestmentAmount = comptrollerProxyToFundSettings[
            _comptrollerProxy
        ].maxInvestmentAmount;
        ...
        return
            _investmentAmount >= minInvestmentAmount &&
            _investmentAmount <= maxInvestmentAmount;
    }
    ...
    function validateRule(
        ...
        (, uint256 investmentAmount, , ) = __decodePostBuySharesValidationData(
            _encodedArgs
        );
