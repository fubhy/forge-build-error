...
contract ProtocolFeeReserveProxy is ProtocolFeeProxyConstants {
    constructor(bytes memory _constructData, address _protocolFeeReserveLib)
        public
    {
        // Validate constants
        require(
        ...
        require(
            ProxiableProtocolFeeReserveLib(_protocolFeeReserveLib)
                .proxiableUUID() == EIP_1822_PROXIABLE_UUID,
        ...
        (bool success, bytes memory returnData) = _protocolFeeReserveLib
            .delegatecall(_constructData);
