...
contract UintListRegistry {
    ...
    function addToList(uint256 _id, uint256[] calldata _items)
        external
        onlyListOwner(_id)
    {
    ...
    function removeFromList(uint256 _id, uint256[] calldata _items)
        external
        onlyListOwner(_id)
    {
        UpdateType updateType = getListUpdateType(_id);
    ...
    function isInList(uint256 _id, uint256 _item)
        public
        view
